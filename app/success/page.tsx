...
const SuccessPage = () => {
  ...
  useEffect(() => {
    // Retrieve the form data from the search parameters
    ...
    if (queryData) {
      setFormData({
        ...
        paymentMethod: JSON.parse(queryData.paymentMethods || '{}'), // Parse payment methods if needed
        accounts: JSON.parse(queryData.accounts || '{}'), // Parse accounts
      });
    }
  }, [searchParams]);
